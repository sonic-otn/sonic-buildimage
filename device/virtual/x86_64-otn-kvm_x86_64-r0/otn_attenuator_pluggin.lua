...
local specs = {
  {'SAI_OTN_ATTENUATOR_ATTR_INGRESS_PORT',        'ingress-port',        hex_decode, ''},
  {'SAI_OTN_ATTENUATOR_ATTR_EGRESS_PORT',         'egress-port',         hex_decode, ''},
  {'SAI_OTN_ATTENUATOR_ATTR_ACTUAL_ATTENUATION',  'actual-attenuation',  scale,      '0'},
  {'SAI_OTN_ATTENUATOR_ATTR_OUTPUT_POWER_TOTAL',  'output-power-total',  scale,      '-60'},
  {'SAI_OTN_ATTENUATOR_ATTR_OPTICAL_RETURN_LOSS', 'optical-return-loss', scale,      '0'},
}
