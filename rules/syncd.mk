...
$(SYNCD)_RDEPENDS += $(LIBLAIREDIS) $(LIBLAIMETADATA)
$(SYNCD)_DPKG_TARGET = binary-syncd
$(SYNCD)_SRC_PATH = $(SRC_PATH)/sonic-lairedis
$(SYNCD)_DEPENDS += $(LIBSWSSCOMMON_DEV) $(LIBLAIREDIS)
...
$(SYNCD_RPC)_RDEPENDS += $(LIBLAIREDIS) $(LIBLAIMETADATA)
