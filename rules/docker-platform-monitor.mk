...
$(DOCKER_PLATFORM_MONITOR)_PYTHON_WHEELS += $(SONIC_SENSORMOND_PY3)
...
$(DOCKER_PLATFORM_MONITOR)_PYTHON_WHEELS += $(SONIC_PM_PY3)
...
$(DOCKER_PLATFORM_MONITOR)_RUN_OPT += -v /host/pmon/sonic-pm:/usr/share/sonic-pm:rw
