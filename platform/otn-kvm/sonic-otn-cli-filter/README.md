...
│                                                                      │
│  debian/rules                                                        │
│    ├─ Install sonic_otn_cli_filter.py                                │
│    │    → /usr/lib/python3/dist-packages/                            │
│    └─ Stage plugin files                                             │
│         → /usr/share/sonic-otn-cli-filter/plugins/                   │
└──────────────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌──────────────────────────────────────────────────────────────────────┐
...
│                                                                      │
│  4. filter_commands() in sonic_otn_cli_filter.py:                    │
│     ┌──────────────────────────────────────────────────────────┐     │
│     │ a. _get_config()                                         │     │
...
```bash
# Install
sudo dpkg -i sonic-otn-cli-filter_1.0.0_all.deb

# Uninstall (prerm removes symlinks automatically)
sudo dpkg -r sonic-otn-cli-filter
```
